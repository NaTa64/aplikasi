...
# ---------------------------------------------------------------------------
def build_graphviz_tree(tree_dict, dot, counter, parent_id=None, branch_label=""):
    ...
    if not isinstance(tree_dict, dict):
        ...
        if parent_id:
            dot.edge(parent_id, node_id, label=str(branch_label))
...
# ---------------------------------------------------------------------------
def visualize_tree_dot(model_tree):
...
# ---------------------------------------------------------------------------
def visualize_tree_svg_bytes(model_tree):
    dot = Digraph(graph_attr={"rankdir": "LR"})
    counter = [0]
